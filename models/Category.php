...
class Category {
    ...
    public static function getCategoriesIdbyUrl($url) {
        ...
        // Текст запроса к БД
        $sql = 'SELECT Id FROM category WHERE url= :url';
    ...
    /**
     * Возвращает Meta данные категории по id
     * @param type $id <p>ID категории</p>
     * @return type <p>Массив с Meta</p>
     */
    public static function getCategoryMeta($id) {
        // Соединение с БД
        $db = Db::getConnection();

        // Текст запроса к БД
        $sql = 'SELECT meta_title, meta_desc FROM category WHERE id = :id';
    ...
    public static function getCategoriesList() {
        ...
        // Запрос к БД
        $result = $db->query('SELECT id, name, url FROM category WHERE status = "1" ORDER BY sort_order, name ASC');
